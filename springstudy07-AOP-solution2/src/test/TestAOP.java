...
public class TestAOP {
	public static void main(String[] args) {
		...
		//SPring IOC Container로부터 확보한 bean 객체의 class 명
		System.out.println(ms.getClass()); //proxy 객체
		System.out.println(ps.getClass()); //proxy 객체
		/*
		...
		System.out.println(testMs.getClass());
